<?php
	...
	$conn = new mysqli('localhost','userpwrsys','pwrsys123','pwrsys');
		...
		if ($result->num_rows > 0) {
			...
			echo $access;
			echo '"></td></tr>';
			echo '<tr width=100%><td>Pump Key</td><td><input type="text" id="pkey" name="pkey" value="';
			echo $pkey;
			echo '"></td></tr>';
			echo '<tr width=100%><td>Power Key</td><td><input type="text" id="mkey" name="mkey" value="';
			echo $mkey;
			echo '"></td></tr>';
			echo '<tr width=100%><td>Motor IP</td><td><input type="text" id="mip" name="mip" value="';
			echo $mip;
			echo '"></td></tr>';
			echo '<tr width=100%><td>Sensor IP</td><td><input type="text" id="pip" name="pip" value="';
			echo $pip;
			echo '"></td></tr>';
			echo '<tr width=100%><td>Motor Hour</td><td><input type="text" id="phr" name="phr" value="';
			echo $phr;
			echo '"></td></tr>';
			echo '<tr><td>';
